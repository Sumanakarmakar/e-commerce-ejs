...
const sendEmailVerificationRegister = async (req, user, token) => {
  // const verificationLink = `${req.get("origin")}/api/confirmation/${
  //   user.email
  // }/${token}`;
  const verificationLink = `${req.protocol}://${req.headers.host}/api/confirmation/${
    user.email
  }/${token}`;
...
const sendEmailVerificationForgotPW = async (req, user, token) => {
  // const resetLink = `${req.get("origin")}/api/reset_password/${
  //   user.email
  // }/${token}`;
  const resetLink = `${req.protocol}://${req.headers.host}/api/reset_password/${
    user.email
  }/${token}`;
...
module.exports = { sendEmailVerificationRegister, sendEmailVerificationForgotPW };
